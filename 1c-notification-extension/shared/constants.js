...
const SHARED_CONSTANTS = {
    ...
    MONITORING: {
        ...
        HD_SKIP_LAST: 3,
        DEFAULT_THRESHOLD: 1,
        DEFAULT_AUTO_TAKE_TIMEOUT: 240000,
        SCROLL_WAIT: 300,
        CLICK_WAIT: 500,
        MENU_WAIT: 1500,
        CONTEXT_WAIT: 2000
    ...
    // ============ Background ============
    BACKGROUND: {
        ICON_UPDATE_COOLDOWN: 2000,
        SHIFT_START_HOUR: 7,
        SHIFT_TRACKING_INTERVAL: 30000
    },
    ...
    STORAGE_KEYS: {
        ...
        AUTO_TAKE_ENABLED: 'autoTakeEnabled',
        AUTO_TAKE_TIMEOUT: 'autoTakeTimeout',
...
// Экспорт для Service Worker (background.js через importScripts)
if (typeof self !== 'undefined' && typeof window === 'undefined') {
    self.SHARED_CONSTANTS = SHARED_CONSTANTS;
}

// Экспорт для popup и content-скриптов
