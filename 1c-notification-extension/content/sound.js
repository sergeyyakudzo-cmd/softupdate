...
export const soundManager = {
    ...
    getInfo() {
        ...
        return {
            ...
            classSoundEnabled: state.classSoundEnabled !== false,
            groupSoundEnabled: state.groupSoundEnabled !== false,
    ...
    async setClassSoundEnabled(enabled) { state.classSoundEnabled = enabled === true; await storage.set({ classSoundEnabled: state.classSoundEnabled }); return { success: true }; },
    async setGroupSoundEnabled(enabled) { state.groupSoundEnabled = enabled === true; await storage.set({ groupSoundEnabled: state.groupSoundEnabled }); return { success: true }; }
};
