...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setupEventListeners() {
        ...
        if (elements.classificationSoundToggle) elements.classificationSoundToggle.addEventListener('click', () => toggleChannelSound('class'));
        if (elements.groupSoundToggle) elements.groupSoundToggle.addEventListener('click', () => toggleChannelSound('group'));
